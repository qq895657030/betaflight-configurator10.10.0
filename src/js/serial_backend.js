...
console.log(`rrrrrrrrrrrrrrrrrrrrrrrrrrrr sensor status`);
        // update connected_to
...
console.log(`ttttttttttttttttttttttttttttttttttttt`);//这里执行了， 但是下面没符合条件没执行
console.log(`FC.CONFIG.boardType: ${FC.CONFIG.boardType}`);//这里执行了， 但是下面没符合条件没执行
        if (FC.CONFIG.boardType === 0 || FC.CONFIG.boardType === 2) {
            console.log('lllllllllllllllllll');//这里执行了， 但是下面没符合条件没执行
